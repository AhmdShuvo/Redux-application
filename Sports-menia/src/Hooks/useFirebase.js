...
useEffect(()=>{
  ...
  fetch(`https://radiant-sands-17727.herokuapp.com/user/admin/${user.email}`).then(res=>res.json()).then(data=>setIsAdmin(data.admin))
...
const saveUsertoDb=(email,displayName)=>{
  ...
  fetch('https://radiant-sands-17727.herokuapp.com/users',{
    method:'POST',
